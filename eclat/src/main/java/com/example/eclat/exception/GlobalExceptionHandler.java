...
public class GlobalExceptionHandler {
    ...
    ResponseEntity<ApiResponse> handlingRuntime(RuntimeException exception) {
...
//    }
    ...
    @ExceptionHandler(value = MethodArgumentNotValidException.class)
    ResponseEntity<ApiResponse> handlingMethodArgumentNoValidException(MethodArgumentNotValidException exception) {
        String enumKey = exception.getFieldError().getDefaultMessage();
